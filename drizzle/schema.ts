...
// Paper Trading Tables (7-Day Simulation)

export const paperTradingSessions = mysqlTable("paper_trading_sessions", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("user_id").notNull(),
...
export type InsertPaperTradingSession = typeof paperTradingSessions.$inferInsert;

export const paperTradingTrades = mysqlTable("paper_trading_trades", {
  id: int("id").autoincrement().primaryKey(),
...
export type InsertPaperTradingTrade = typeof paperTradingTrades.$inferInsert;

export const paperTradingPortfolio = mysqlTable("paper_trading_portfolio", {
  id: int("id").autoincrement().primaryKey(),
  sessionId: int("session_id").notNull(),
  userId: int("user_id").notNull(),
  symbol: varchar("symbol", { length: 20 }).notNull(),
...
export type PaperTradingPortfolio = typeof paperTradingPortfolio.$inferSelect;
export type InsertPaperTradingPortfolio = typeof paperTradingPortfolio.$inferInsert;
