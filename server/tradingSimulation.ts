...
export function generateRealisticTrade(
  ...
  // Simulate entry price (entry at current market price)
  const entryPrice = currentPrice;
  
  // Simulate exit price with LARGER volatility for realistic profits
  // Use 3-8% price movement instead of 2.5%
  const largerVolatility = 3 + Math.random() * 5; // 3-8% movement
